...
|----------|-------|-------|
| **Security** | pass-gen, uuid-gen, hash-gen | Node.js + Python |
| **Data** | json-prettifier, json-validator, text-diff, base64-tool | Node.js + Python |
| **Files** | file-counter, csv-viewer, file-watcher, batch-renamer | Node.js + Python |
| **Utilities** | timestamp, url-encode, color-convert, quick-note | Node.js + Python |
